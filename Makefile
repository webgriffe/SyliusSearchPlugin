...
backend:
	...
	tests/Application/bin/console doctrine:schema:update --force # This will add Search plugin tables
	tests/Application/bin/console sylius:fixtures:load default --no-interaction

elasticsearch:
	tests/Application/bin/console monsieurbiz:search:populate --no-interaction
...
init: install backend frontend elasticsearch
